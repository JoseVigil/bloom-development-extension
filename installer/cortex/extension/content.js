...
//
// CHANGELOG v2.3
// Agrega handlers explícitos para SYNAPSE_SIMULATOR_PROTOCOL_MANIFEST v2.0:
  ...
  (async () => {
    try {
      ...
      switch (command) {
        ...
        // DOM_EXTRACT — alias de DOM_READ para compatibilidad con SYNAPSE_SIMULATOR_PROTOCOL_MANIFEST v2.0
