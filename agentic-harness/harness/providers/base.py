...
rol real (ver DECISION-ollama-role.md). `capabilities` usa el mismo
vocabulario que contracts/types.ts AIProvider['capabilities'].
"""
...
from harness.contracts.types import AIPromptPayload, AIProviderCapability, AIProviderId
