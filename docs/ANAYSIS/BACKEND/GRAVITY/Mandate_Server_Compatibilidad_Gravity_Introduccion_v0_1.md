...
- **Gravity** queda fijado como el sistema de gobernanza del criterio en su totalidad — Postures, `gravityPostures[]`, resolución por turno, arbitraje, masa, promoción. Es exactamente lo que el Mandate Server necesita comparar.
...
1. **Representación mínima de Gravity.** Qué subconjunto de posturas/`gravityPostures[]` de un Mandate necesita viajar para que el servidor pueda compararlo, sin requerir el `GravityGraph` completo de la organización de origen.
