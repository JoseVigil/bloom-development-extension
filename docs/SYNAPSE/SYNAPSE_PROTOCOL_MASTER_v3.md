...
> recibidos por el debug panel (Workspace Harness). Sentinel los recibe a través de
...
- **WS nucleus `:4124`** — observabilidad del debug panel (Workspace Harness). Los eventos
