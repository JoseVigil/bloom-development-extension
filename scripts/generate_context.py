...
Uso: python generate_context.py --strategy=android [--root=.] [--output=.bloom]
"""
...
Ejemplos:
  python generate_context.py --strategy=android
  python generate_context.py --strategy=react-web --root=./my-project
  python generate_context.py --strategy=node --output=.bloom-custom
        """
    )
