...
def generate_tree_files(brain_exe):
    ...
    tree_commands = [
        {"args": ["filesystem", "tree", "src", "installer", "brain", "-o", "tree/src_tree.txt"], "file": "src_tree.txt"},
        ...
        {"args": ["filesystem", "tree", "installer/launcher", "-o", "tree/launcher_tree.txt"], "file": "launcher_tree.txt"},
