...
exports.createErrorFromException = createErrorFromException;
...
exports.shouldLogToTelemetry = shouldLogToTelemetry;
exports.getTelemetryEventName = getTelemetryEventName;
// ============================================================================
// ERROR CATALOG
// ============================================================================
/**
 ...
 * ```
 */
function createErrorFromException(error, code = 'INTERNAL_ERROR') {
...
function isRecoverableError(code) {
    return exports.ERROR_CATALOG[code].severity !== 'critical';
}
/**
 ...
 */
function getRetryDelay(code, attemptNumber = 1) {
    const catalog = exports.ERROR_CATALOG[code];
...
function getHttpStatus(code) {
    return exports.ERROR_CATALOG[code].http_status || 500;
}
/**
 * Check if error should be logged to telemetry
 */
function shouldLogToTelemetry(code) {
 ...
 */
function getTelemetryEventName(code) {
    const catalog = exports.ERROR_CATALOG[code];
