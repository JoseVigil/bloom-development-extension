"""
Gemini multi-key credential management for Bloom.
...
Este módulo es el que brain/shared/credentials/__init__.py ya esperaba
encontrar (bloque `try: from .gemini_manager import GeminiKeyManager
except ImportError: pass`) pero que nunca había sido creado — por eso
GeminiKeyManager, NoAvailableKeysError y GeminiAPIError quedaban rotos
en runtime sin que el ImportError se propagara (tragado en silencio por
ese try/except).
"""
